...
// node_modules/styled-components/dist/styled-components.browser.esm.js
var v = typeof process != "undefined" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled";
var g = "6.0.0-rc.1";
...
var C = Object.freeze({});
function I(e, t, n2) {
  return n2 === void 0 && (n2 = C), e.theme !== n2.theme && e.theme || t || n2.theme;
}
...
function ae(e, t, n2) {
  if (n2 === void 0 && (n2 = false), !n2 && !ie(e) && !Array.isArray(e))
    return t;
  if (Array.isArray(t))
...
var we = function(e, t) {
  for (var n2, r2 = ((n2 = t.textContent) !== null && n2 !== void 0 ? n2 : "").split("/*!sc*/\n"), o2 = [], s2 = 0, i2 = r2.length; s2 < i2; s2++) {
    var a2 = r2[s2].trim();
    if (a2) {
      var c2 = a2.match(ge);
      if (c2) {
        var l2 = 0 | parseInt(c2[1], 10), u2 = c2[2];
        l2 !== 0 && (ye(u2, l2), Se(e, u2, c2[3]), e.getTag().insertRules(l2, o2)), o2.length = 0;
      } else
        o2.push(a2);
    }
  }
...
var Ae = function() {
  function e(e2, n2, r2) {
    e2 === void 0 && (e2 = C), n2 === void 0 && (n2 = {}), this.options = __assign(__assign({}, Ie), e2), this.gs = n2, this.names = new Map(r2), this.server = !!e2.isServer, !this.server && S && Ce && (Ce = false, function(e3) {
      for (var t = document.querySelectorAll(ve), n3 = 0, r3 = t.length; n3 < r3; n3++) {
        var o2 = t[n3];
        o2 && o2.getAttribute(v) !== "active" && (we(e3, o2), o2.parentNode && o2.parentNode.removeChild(o2));
      }
    }(this));
  }
  return e.registerId = function(e2) {
    ...
    return r2 === void 0 && (r2 = true), new e(__assign(__assign({}, this.options), n2), this.gs, r2 && this.names || void 0);
    ...
    return function(e2) {
      for (var t = e2.getTag(), n2 = t.length, r2 = "", o2 = function(n3) {
        ...
        s3 !== void 0 && s3.forEach(function(e3) {
...
function Te(e) {
  var t, n2, r2, o2 = e === void 0 ? C : e, s2 = o2.options, i2 = s2 === void 0 ? C : s2, a2 = o2.plugins, c2 = a2 === void 0 ? _ : a2, l2 = function(e2, r3, o3) {
  ...
  var y = function(e2, o3, s3, a3) {
    o3 === void 0 && (o3 = ""), s3 === void 0 && (s3 = ""), a3 === void 0 && (a3 = "&"), t = a3, n2 = o3, r2 = new RegExp("\\".concat(n2, "\\b"), "g");
...
var $e = function() {
  ...
  return e.prototype.getName = function(e2) {
    return e2 === void 0 && (e2 = xe), this.name + e2.hash;
  }, e;
}();
var ze = function(e) {
  return e >= "A" && e <= "Z";
...
var Ye = function(t) {
  ...
  for (var s2 in t) {
    var i2 = t[s2];
    t.hasOwnProperty(s2) && !Ge(i2) && (Array.isArray(i2) && i2.isCss || ne(i2) ? o2.push("".concat(Le(s2), ":"), i2, ";") : ie(i2) ? o2.push.apply(o2, __spreadArray(__spreadArray(["".concat(s2, " {")], Ye(i2), false), ["}"], false)) : o2.push("".concat(Le(s2), ": ").concat((n2 = s2, (r2 = i2) == null || typeof r2 == "boolean" || r2 === "" ? "" : typeof r2 != "number" || r2 === 0 || n2 in unitlessKeys || n2.startsWith("--") ? String(r2).trim() : "".concat(r2, "px")), ";")));
  }
  return o2;
};
function We(e, t, n2, r2) {
  ...
  if (ne(e)) {
    if (!ne(s2 = e) || s2.prototype && s2.prototype.isReactComponent || !t)
      return [e];
    var o2 = e(t);
    return typeof o2 != "object" || Array.isArray(o2) || o2 instanceof $e || ie(o2) || o2 === null || console.error("".concat(B(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), We(o2, t, n2, r2);
  }
  var s2;
...
function Ke(e) {
  var r2 = Ze(), o2 = (0, import_react.useMemo)(function() {
    return function(e2, n2) {
      ...
      if (ne(e2)) {
        var r3 = e2(n2);
        if (r3 === null || Array.isArray(r3) || typeof r3 != "object")
          throw ue(7);
        return r3;
      }
...
var Qe = {};
function et(e, r2, o2) {
  var s2 = re(e), i2 = e, a2 = !$(e), u2 = r2.attrs, p = u2 === void 0 ? _ : u2, d = r2.componentId, h = d === void 0 ? function(e2, t) {
    var n2 = typeof e2 != "string" ? "sc" : R(e2);
    Qe[n2] = (Qe[n2] || 0) + 1;
    var r3 = "".concat(n2, "-").concat(F("6.0.0-rc.1" + n2 + Qe[n2]));
    return t ? "".concat(t, "-").concat(r3) : r3;
  }(r2.displayName, r2.parentComponentId) : d, f = r2.displayName, m = f === void 0 ? function(e2) {
  ...
  var b2 = new Ue(o2, y, s2 ? i2.componentStyle : void 0), E2 = b2.isStatic && p.length === 0;
  function N2(e2, n2) {
    return function(e3, n3, r3, o3) {
      ...
      var y2 = function(e4, n4, r4) {
        for (var o4, s4 = __assign(__assign({}, n4), { className: void 0, theme: r4 }), i4 = 0; i4 < e4.length; i4 += 1) {
          ...
          for (var c2 in a4)
            s4[c2] = c2 === "className" ? oe(s4[c2], a4[c2]) : c2 === "style" ? __assign(__assign({}, s4[c2]), a4[c2]) : a4[c2];
        }
        return n4.className && (s4.className = oe(s4.className, n4.className)), s4;
      }(s3, n3, I(n3, h2, a3) || C), v3 = y2.as || d2, g3 = {};
      for (var S3 in y2)
        y2[S3] === void 0 || S3[0] === "$" || S3 === "as" || S3 === "theme" || (S3 === "forwardedAs" ? g3.as = y2.forwardedAs : m2 && !m2(S3, v3) || (g3[S3] = y2[S3]));
...
function rt(t) {
  ...
  var s2 = t;
  return n2.length === 0 && s2.length === 1 && typeof s2[0] == "string" ? We(s2) : nt(We(tt(s2, n2)));
}
function ot(n2, r2, o2) {
  if (o2 === void 0 && (o2 = C), !r2)
    throw ue(1, r2);
  var s2 = function(t) {
...
function ut(e) {
  var r2 = import_react.default.forwardRef(function(r3, o2) {
    ...
    return s2 === void 0 && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(B(e), '"')), import_react.default.createElement(e, __assign({}, r3, { theme: s2, ref: o2 }));
  });
...
typeof window != "undefined" && (window[ht] || (window[ht] = 0), window[ht] === 1 && console.warn("It looks like there are several instances of 'styled-components' initialized in this application. This may cause dynamic styles to not render properly, errors during the rehydration process, a missing theme prop, and makes your application bigger without good reason.\n\nSee https://s-c.sh/2BAXzed for more info."), window[ht] += 1);

// dep:styled-components
var styled_components_default = it;
export {
